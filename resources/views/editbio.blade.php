...
@section('konten')
    <div class="container"><br>
        <div class="col-md-6 col-md-offset-3">
                <hr>
                <a type="submit" class="btn btn-primary btn-block text-light mb-4" href="pengalaman">Tambahkan Pengalaman</a>
                <form action="{{ route('actionedit') }}" method="post">
                    ...
                    <div class="form-group">
                        <label>Nama</label>
                        <input type="text" name="name" class="form-control" placeholder="Nama" value="{{ Auth::user()->nama }}">
                    </div>
                    <div class="form-group">
